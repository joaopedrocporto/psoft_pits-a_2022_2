...
public class SaborControllerTests {
    ...
    void setup() {
        ...
        // o estabelecimento precisa existir antes: anexar um sabor ja persistido a um
        // estabelecimento novo dispara cascade PERSIST numa entidade detached.
        estabelecimento = estabelecimentoRepository.save(Estabelecimento.builder()
                .codigoAcesso("654321")
                .build());
        sabor = salvarSaborDoEstabelecimento(Sabor.builder()
                .nome("Calabresa")
                .tipo("salgado")
                .precoM(10.0)
                .precoG(15.0)
    ...
    /** Vincula o sabor ao estabelecimento do teste, como o fluxo de criacao faz. */
    private Sabor salvarSaborDoEstabelecimento(Sabor novoSabor) {
        Sabor salvo = saborRepository.save(novoSabor);
        estabelecimento.getSabores().add(salvo);
    ...
    class SaborVerificacaoFluxosBasicosApiRest {
        ...
        void quandoBuscamosPorTodosSaboresSalvos() throws Exception {
            ...
            Sabor sabor2 = Sabor.builder()
                    ...
                    .disponivel(true)
                    .build();
            salvarSaborDoEstabelecimento(sabor1);
            salvarSaborDoEstabelecimento(sabor2);
        ...
        @Test
        @DisplayName("Quando listamos o cardapio nao devemos ver sabores de outro estabelecimento")
        void quandoListamosCardapioNaoVemosSaboresDeOutroEstabelecimento() throws Exception {
            // Arrange
            Estabelecimento outro = estabelecimentoRepository.save(Estabelecimento.builder()
                    .codigoAcesso("111111")
                    .build());
            Sabor saborDoOutro = saborRepository.save(Sabor.builder()
                    .nome("Sabor Alheio")
                    .tipo("doce")
                    .precoM(10.0)
                    .precoG(15.0)
                    .disponivel(true)
                    .build());
            outro.getSabores().add(saborDoOutro);
            estabelecimentoRepository.save(outro);
            ...
            assertAll(
                    ...
                    () -> assertEquals(sabor.getId(), resultado.get(0).getId())
            );
        }

        @Test
        @DisplayName("Quando buscamos um sabor de outro estabelecimento pelo id")
        void quandoBuscamosSaborDeOutroEstabelecimento() throws Exception {
            // Arrange
            Sabor saborDoOutro = saborRepository.save(Sabor.builder()
                    .nome("Sabor Alheio")
                    .tipo("doce")
            ...
            // Act
            String responseJsonString = driver.perform(get(URI_SABORES + "/" + saborDoOutro.getId())
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("estabelecimentoId", estabelecimento.getId().toString())
                            .param("estabelecimentoCodigoAcesso", estabelecimento.getCodigoAcesso()))
